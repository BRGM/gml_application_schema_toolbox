...
class TestGMLASXPath(unittest.TestCase):
    ...
    def test_timeseries(self):
        ...
        v = resolver.resolve_xpath("measurementtimeseries", "id", "timeseries.927B7F661CE9CF9F3BF931A87E119E524A5B328F", "point/MeasurementTVP/time/text()")
        self.assertEqual(len(v), 5000)
        v = resolver.resolve_xpath("measurementtimeseries", "id", "timeseries.927B7F661CE9CF9F3BF931A87E119E524A5B328F", "defaultPointMetadata/DefaultTVPMeasurementMetadata/interpolationType/@xlink:title")
        self.assertEqual(v, ['Instantaneous'])
        v = resolver.resolve_xpath("measurementtimeseries", "id", "timeseries.927B7F661CE9CF9F3BF931A87E119E524A5B328F", "defaultPointMetadata/DefaultTVPMeasurementMetadata/uom/@code")
